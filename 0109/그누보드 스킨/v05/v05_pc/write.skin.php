...
<section id="bo_w">
					...
					<tr>
						<td colspan=2 style="padding:8px 3px 5px 3px;border-top:1px dashed #bbbbbb">
							<table style=width:100%;table-layout:fixed cellpadding=0 cellspacing=0>
								...
								<td style=width:40% align=right valign=bottom><?php if ($file[$i]['file']) echo "<span style=color:#580ca3;font-weight:bold;cursor:pointer onclick=copyMode('".$file[$i]['path'].'/'.$file[$i]['file']."','파일주소가')>주소복사</span>"; ?></td>
							</table>
						</td>
					</tr>
				</table>
    ...
    <div class="btn_confirm write_div">
		...
		<button class="btn_submit btn" style=background-color:#c00000 onclick=sessionStorage.returnWrite=1>작성점검</button>
