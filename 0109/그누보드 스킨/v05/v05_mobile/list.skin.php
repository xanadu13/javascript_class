        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
				...
				<div style=margin-right:10px;float:left>
					<?php $thumb = $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], 120, 120, false, true); ?>
					<img onerror=style.display='none' style=width:90px;height:90px;cursor:pointer;display:block;object-fit:cover;border-radius:5px src=<?php echo $thumb['src']; ?> onclick=location.href='<?php echo $list[$i]['href']; ?>'>
				</div>
				...
				<div class="bo_info" style=position:static>
