...
<body>
  ...
  <main>
    ...
    $query = "INSERT INTO drive VALUES (0, '".$name."', '".$phone."', '".$email."' ,'".$sms."', '".$place."', '".$car."', '".$have."', '".$date."')";

    $result = mysqli_query($conn, $query);

    echo '<div class="complate">시승신청 예약이 완료되었습니다.</div>
    <p><a href="search.php" title="시승신청 조회하기" class="drive_re">시승신청 조회하기</a></p>
    ' ;
